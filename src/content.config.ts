...
export const collections = {
	'what-we-do': markdown(
		'src/content/what-we-do',
		z.object({ name: z.string(), logo: z.string(), link: z.string(), download: z.string().optional() })
	),
	testimonial: markdown('src/content/testimonial', z.object({ pic: z.string(), field: z.string().optional() })),
	'who-we-are': markdown(
		'src/content/who-we-are',
		z.object({ word: z.string(), color: z.string(), rotation: z.string() })
	),
};
